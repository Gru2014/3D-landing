...
const RoadCard: React.FC<RoadmapProps> = ({ card, direction, isActive }) => {
    return (
        <div className={`transition-all border-gradient hover:w-[450px] p-[3px]  cursor-pointer hover:mr-0 hover:rounded-[20px] ${direction === 'right' ? isActive?'w-[450px] mr-0 rounded-[20px]': 'w-[225px] rounded-l-[20px]' : 'rounded-r-[20px] mr-[225px] w-[225px]'} min-h-[450px]`}>
