...
const Dashboard = () => {
  ...
  return (
    <div className='w-screen h-screen flex justify-center items-center background relative' id='home'>
      <div className=''>
        <h1 className='text-[68px] focus-color text-center font-bold leading-[82.3px]'>The Ultimate On-Chain</h1>
        <h1 className='text-[68px] focus-color text-center font-bold leading-[82.3px]'>Dashboard is Here</h1>
