            ...
            <div className="relative wrap flex overflow-hidden p-10">
                ...
                <div className='flex basis-2/12'>
                    <div className='flex relative justify-end basis-1/2'>
                        ...
                        <div className=' absolute w-full h-0.5 top-[238px] '><img src="assets/icons/timeline-left.svg" alt="" /></div>
                        <div className=' absolute w-full h-0.5 top-[813px] '><img src="assets/icons/timeline-right.svg" alt="" /></div>
                    </div>
                    <div className='flex relative basis-1/2'>
                        ...
                        <div className=' absolute w-full h-0.5  top-[463px] '><img src="assets/icons/timeline-right.svg" alt="" /></div>
                        <div className=' absolute w-full h-0.5  top-[1000px] '><img src="assets/icons/timeline-left.svg" alt="" /></div>
                    </div>
                </div>
