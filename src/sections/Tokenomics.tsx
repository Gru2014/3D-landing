...
const Tokenomics: React.FC = () => {
  ...
  return (
    <div className=' min-h-screen flex flex-col w-screen max-[769px]:h-auto relative' id='tokenomics'>
      ...
      <div className='flex flex-row basis-4/5 max-[769px]:flex-col'>
        <div className='flex w-[55%] max-[769px]:w-screen justify-center relative items-center'>
          <div className='w-[800px] h-[700px] max-[769px]:h-[500px] flex justify-center items-center relative'>
            <div className='flex absolute flex-row w-full h-full text-white'>
              ...
              <div className='flex flex-col basis-1/2'>
                ...
                <div className='flex basis-1/12 min-[769px]:ml-10 justify-center items-center '>
            ...
            <div className={`absolute z-[12] w-[448px] h-[448px] max-[769px]:scale-75 rounded-full cursor-pointer ${hoverIndexColor === 2 || isNaN(hoverIndexColor) ? 'tokenomic65-high' : 'tokenomic65'}`} > </div>
            <div className={`absolute z-[13] left-[402px] top-[126px] max-[769px]:left-[377px] max-[769px]:top-[74px] max-[449px]:left-[208px]  w-[65px] h-[69px] max-[769px]:scale-75 cursor-pointer ${hoverIndexColor === 3 || isNaN(hoverIndexColor) ? 'tokenomic5-high' : 'tokenomic5'}`} ></div>
            <div className={`absolute z-[14] left-[451px] top-[140px] max-[769px]:left-[404px] max-[769px]:top-[79px] max-[449px]:left-[235px]  w-[130px] h-[115px] max-[769px]:scale-75 ${hoverIndexColor === 0 || isNaN(hoverIndexColor) ? 'tokenomic101-high' : 'tokenomic101'} cursor-pointer`} ></div>
            <div className={`absolute z-[13] left-[536px] top-[223px] max-[769px]:left-[473px] max-[769px]:top-[139px] max-[449px]:left-[304px]  w-[90px] h-[128px] max-[769px]:scale-75 ${hoverIndexColor === 1 || isNaN(hoverIndexColor) ? 'tokenomic102-high' : 'tokenomic102'} cursor-pointer`} ></div>
            <div className={`absolute z-[13] left-[535px] top-[353px] max-[769px]:left-[473px] max-[769px]:top-[237px] max-[449px]:left-[304px]  w-[90px] h-[128px] max-[769px]:scale-75 ${hoverIndexColor === 4 || isNaN(hoverIndexColor) ? 'tokenomic103-high' : 'tokenomic103'} cursor-pointer`} ></div>
        ...
        <div className='flex w-[45%]  max-[769px]:w-full flex-col my-6 max-[769px]:items-center max-[769px]:gap-5 items-start justify-around'>
          ...
          <div className='w-[600px] h-[175px] max-[769px]:w-5/6 max-[769px]:h-auto border-gradient-right rounded-[20px] p-[3px]'>
            <div className='w-full h-full bg-black flex flex-row max-[769px]:flex-col rounded-[20px]'>
